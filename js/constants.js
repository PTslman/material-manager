...
window.refreshConstantsData = function() {
    ...
    console.log('✅ Constants refreshed');
    return true;
};
...
console.log('   Important:', importantItemsList.length);
console.log('   Spices:', spicesExtraItemsList.length);
console.log('   Extra:', extraItemsList.length);
